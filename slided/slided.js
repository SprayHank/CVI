/**
 * slided.js 1.5 (10-Aug-2010) (c) by Christian Effenberger 
...
if(window.addEventListener) window.addEventListener("load",addSlides,false);
else window.attachEvent("onload",addIESlides);